...
//    public static void main(String[] args) {}
    ...
    /**
     * Wiederholt zur�ckgenommene Z�ge.
     * @param str String, der die zu wiederholenden Z�ge speichert.
     */
    ...
    private void loadGame(String gameName) {
    	filestream.loadDraws(gameName); // aktualisiert die IVs in den Klassen f�r Punkte und Z�ge
